        ...
        <div class="row">
                ...
                <div class="form-row pt-4 font-size-16 font-Poppins">
                    ...
                    <div class="col">
                        ...
                        if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                            ...
                            echo '<button type="submit" name="top_sale_submit" class="btn btn-info font-size-16 form-control">Add to Cart</button>';
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="col-sm-6 py-5">
                ...
                <div class="d-flex">
                    ...
                    <a href="#" class="px-2 font-Poppins font-size-14">20,534 ratings | 1000+ answered questions</a>
                </div>
                <hr class="m-0">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-Poppins font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">₹5999</span></td>
                    </tr>
                </table>
                <!---    !product price       -->
                ...
                <div id="policy">
                    <div class="d-flex">
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-Poppins font-size-12">7 Days <br> Replacement</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-truck  border p-3 rounded-pill"></span>
                            </div>
                            <a href="#" class="font-Poppins font-size-12">Safe & Secure <br>Delivery</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                ...
                <div id="order-details" class="font-Poppins d-flex flex-column text-dark">
                    <small>Delivery by :  3 Days</small>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="qty d-flex">
                            <h6 class="font-Poppins">Qty</h6>
                            <div class="px-4 d-flex font-Poppins">
                ...
                <!-- size -->
                <div class="size my-3">
                    <h6 class="font-Poppins">Size :</h6>
                    <div class="d-flex justify-content-between w-75">
                        <div class="font-Poppins border p-2">
