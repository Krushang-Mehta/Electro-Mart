                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-Poppins font-size-14">20,534 ratings</a>
                        </div>
                        <!--  !product rating-->
                        ...
                        <div class="qty d-flex pt-2">
                            ...
                            <form method="post">
                                ...
                                <button type="submit" name="delete-cart-submit" class="btn font-Poppins text-danger px-3 border-right">Delete</button>
                            </form>

                            <form method="post">
                                <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                <button type="submit" name="wishlist-submit" class="btn font-Poppins text-danger">Save for Later</button>
                            </form>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <button type="submit" class="btn btn-info mt-3">Proceed to Buy</button>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
